...
export default function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "お客様の課題やご要望によって異なります。まずは無料相談でヒアリングさせていただき、お見積りを作成いたします。予算に合わせた最適なプランをご提案いたしますので、お気軽にご相談ください。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "もちろんです！無料相談を実施しておりますので、まずはお気軽にお問い合わせください。お客様の現状の課題や悩みをお聞きし、どのような解決策があるかをご提案いたします。相談したからといって必ず契約しなければならないということはありませんので、ご安心ください。",
    },
    {
      question: "GPTsとは何ですか?",
      answer:
